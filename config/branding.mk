...
ION_VERSION := ion-go-$(ION_BUILD)-$(ION_PLATFORM_VERSION)-$(ION_BUILD_DATE)-$(ION_BUILD_TYPE)
ION_FINGERPRINT := ion-go/$(ION_PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(ION_BUILD_DATE)
else
ION_VERSION := ion-$(ION_BUILD)-$(ION_PLATFORM_VERSION)-$(ION_BUILD_DATE)-$(ION_BUILD_TYPE)

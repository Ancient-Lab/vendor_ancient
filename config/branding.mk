...
ANCIENT_VERSION_CUSTOM := CIVILIZATION-v3.0.1
BUILD_VERSION := v3.0.1
...
ANCIENT_VERSION := AncientOS-$(ANCIENT_BASE_EDITION)-$(BUILD_VERSION)-$(ANCIENT_BUILD)-$(ANCIENT_BUILD_TYPE)-$(ANCIENT_BUILD_DATE)
